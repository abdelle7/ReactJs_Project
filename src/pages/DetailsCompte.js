...
class DetailsCompte extends Component {
  ...
  handleSubmit = e => {
    ...
    collection
      ...
      .catch(
        err => console.error(`Failed to add review: ${err}`),
        this.setState({ isloadingUpdate: false })
      );
  };
            ...
            <div>
              <Sidebar.Pushable style={{ height: "200px" }}>
                <Sidebar
                  ...
                  visible={visible}
                >
                  <h1 style={{ color: "black", margin: "10px 0 0 6px " }}>
                    Detail Du Compte
                  </h1>
              ...
              <span className="FormCN">
                <MDBContainer className="MDBContainer">
                  ...
                  <MDBRow className="rowCont ">
                    <MDBCol className=" pt-3 d-flex align-items-center">
                      <label className="labelCN">Dénomination</label>
                    </MDBCol>
                    <MDBCol className="align-items-center ml-5">
                      <span>
                        <input
                          className="mt-2"
                          style={{
                    ...
                    <MDBCol className="d-flex align-items-center">
                      <i
                        ...
                        onClick={this.focus(1)}
                      />
                    </MDBCol>
                  </MDBRow>
                  <MDBRow className="midRow">
                    <MDBCol className="pt-3 d-flex align-items-center">
                      <label className="labelCN">Contact</label>
                    </MDBCol>
                    <MDBCol className="align-items-center ml-5">
                      <span>
                        <input
                    ...
                    <MDBCol className="d-flex align-items-center">
                      <i
                        className="ion-md-create"
                        style={{ cursor: "pointer" }}
                        onClick={this.focus(2)}
                      />
                    </MDBCol>
                  </MDBRow>
                  <MDBRow className="midRow">
                    <MDBCol className=" pt-3 d-flex align-items-center">
                      <label className="labelCN">Lorem</label>
                    </MDBCol>
                    <MDBCol className="align-items-center ml-5">
                      <span>
                        <input
                    ...
                    <MDBCol className="d-flex align-items-center">
                      <i
                        className="ion-md-create"
                        style={{ cursor: "pointer" }}
                        onClick={this.focus(3)}
                      />
                    </MDBCol>
                  </MDBRow>
                  <MDBRow className="lastRow">
                    <MDBCol className=" pt-3 d-flex align-items-center">
                      <label className="labelCN">Site WEB</label>
                    </MDBCol>
                    <MDBCol className="align-items-center ml-5">
                      <span>
                        <input
